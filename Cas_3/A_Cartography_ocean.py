...
ds0 = open_mdsdataset(dir0,prefix=['U','V','W','T','S','Eta'])            #Case 3 : Without winds
...
plt.savefig('Cartography_ETA_cas3'+'.png')                                    #Save figure
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
plt.savefig('Cartography_T_cas3'+'.png')
plt.clf()
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
plt.savefig('Cartography_S_cas3'+'.png')
plt.clf()
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
plt.savefig('Cartography_U_cas3'+'.png')
plt.clf()
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
plt.savefig('Cartography_V_cas3'+'.png')
plt.clf()
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
plt.savefig('Cartography_W_cas3'+'.png')
plt.clf()
