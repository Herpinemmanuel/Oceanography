...
while (nt < 1000) :
  ...
  plt.text(-45,-4500,nt)
  if (nt < 10):
   plt.savefig('Temperature_Vertical_section_yz_Cas6-'+'00'+str(nt)+'.png')
   plt.clf()
  elif (nt > 9) and (nt < 100):
   plt.savefig('Temperature_Vertical_section_yz_Cas6-'+'0'+str(nt)+'.png')
   plt.clf()
  else:
   plt.savefig('Temperature_Vertical_section_yz_Cas6-'+str(nt)+'.png')
   plt.clf()
